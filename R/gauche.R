#' Genetic Algorithm for Understanding Clonal Heterogeneity (GAUCHE)
#' 
...
gauche<-function(observations, number_of_clones, pop_size=100, mutation_rate=0.8, iterations=1000,
